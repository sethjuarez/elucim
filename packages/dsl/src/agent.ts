...
const AGENT_OPERATION_CATALOG: readonly AgentOperationDescriptor[] = [
  ...
  { name: 'createCalculusDerivativeScenePreset', kind: 'author', async: false, description: 'Create an agent-safe calculus lesson scene comparing secant and tangent slopes from canonical calculus primitives.' },
  { name: 'createCalculusRiemannScenePreset', kind: 'author', async: false, description: 'Create an agent-safe calculus lesson scene showing Riemann rectangles over a function curve.' },
  { name: 'createCalculusAccumulationScenePreset', kind: 'author', async: false, description: 'Create an agent-safe calculus lesson scene shading accumulated integral area under a function curve.' },
  ...
  { name: 'createBoundaryPreset', kind: 'author', async: false, description: 'Create an editable labeled boundary/container group for ownership, scope, phase, or system regions.' },
  { name: 'createBadgePreset', kind: 'author', async: false, description: 'Create an editable badge/pill label with token colors.' },
  { name: 'createQueueStackPreset', kind: 'author', async: false, description: 'Create an editable queue/stack ordered collection visual.' },
  { name: 'createTimelineRoadmapPreset', kind: 'author', async: false, description: 'Create an editable horizontal or vertical milestone roadmap.' },
