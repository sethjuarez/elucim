...
export interface ElucimEditorProps {
  ...
  showHeader?: boolean;
  /** Called whenever the canonical document changes. */
 ...
 */
export function ElucimEditor({ initialDocument, initialFrame, theme, editorTheme, showHeader = true, className, style, onDocumentChange, onBrowseImage, imageResolver }: ElucimEditorProps) {
  let inner = (
