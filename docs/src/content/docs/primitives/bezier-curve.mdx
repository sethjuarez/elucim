...
The `bezierCurve` primitive renders SVG Bezier curves — either **quadratic** (one control point) or **cubic** (two control points). Use it for smooth paths, flow diagrams, and organic shapes.
...
elements: {
  quadratic: {
    id: 'quadratic',
    type: 'bezierCurve',
    props: { type: 'bezierCurve', x1: 50, y1: 250, cx1: 250, cy1: 30, x2: 450, y2: 250, stroke: '$accent', strokeWidth: 3 },
  },
  cubic: {
    id: 'cubic',
    type: 'bezierCurve',
