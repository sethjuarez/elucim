...
description: Edit canvas, Object, motion, and polish properties in the current editor UI.
---
...
| Duration | Shown for linear playback contexts; timeline duration belongs to timelines. |
...
The inspector does not create wrapper animation props. Motion is authored in timelines and state machines.
