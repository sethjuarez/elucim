...
The editor also exposes basic v2-native controls: document metadata and selected element intent fields in the States panel, reviewable polish nudges from `suggestDocumentNudges()`, simple timeline clip/keyframe editing, and simple state-machine transition editing.
