...
<img class="theme-img-dark" src="/images/editor/editor-overview-dark.png" alt="Elucim Editor — dark mode with toolbar, canvas, and timeline" />
<img class="theme-img-light" src="/images/editor/editor-overview-light.png" alt="Elucim Editor — light mode with toolbar, canvas, and timeline" />
...
<img class="theme-img-dark" src="/images/editor/editor-element-selected.png" alt="Element selected with resize handles and inspector panel" />
<img class="theme-img-light" src="/images/editor/editor-element-selected-light.png" alt="Element selected with resize handles and inspector panel (light mode)" />
...
<img class="theme-img-dark" src="/images/editor/editor-timeline.png" alt="Timeline with playback controls and animation bars" />
<img class="theme-img-light" src="/images/editor/editor-timeline-light.png" alt="Timeline with playback controls and animation bars (light mode)" />
