...
description: How rotation, scale, translate, hierarchy order, and Group compose uniformly across all primitives.
---
...
- Move elements up/down in the editor hierarchy, or use agent order commands, to change stacking
