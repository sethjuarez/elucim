...
| Quality | `evaluateSceneForAgent`, `inspectSceneForAgent`, `analyzePolish` | Catch missing metadata, missing motion, blank frames, tiny scenes, off-canvas elements, zero-size elements, low contrast, graph readability issues, weak hierarchy, and static timelines. |
