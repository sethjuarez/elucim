...
:::note
`DslRenderer` calls `validate` automatically and displays errors inline. You only need to call `validate` directly if you want to check documents outside of a React render.
:::
