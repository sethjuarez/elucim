...
:::tip
Theme tokens affect the wrapper CSS (borders, backgrounds, spacing). This is different from [Builder API](/dsl/builder-api/) themes, which affect content colors inside the scene.
:::
